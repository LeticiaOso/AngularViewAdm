...
namespace AngularViewAdm.Controllers
{
    public class CajasController : Controller
    {
        ...
        {
            var u535755128_AngularviewContext = _context.Caja.Include(c => c.IdEventoNavigation).Include(c => c.IdSalaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,IdSala,IdEvento,Tipo,Activo,Modificado,Costo,Ocupado")] Caja caja)
        {
