...
namespace AngularViewAdm.Controllers
{
    public class AltaExpositorsController : Controller
    {
        ...
        public AltaExpositorsController(u535755128_AngularviewContext context)
        {
            _context = context;
        }
        ...
        {
            var u535755128_AngularviewContext = _context.AltaExpositor.Include(a => a.IdExpositorNavigation).Include(a => a.IdVendedorNavigation);
