...
namespace AngularViewAdm.Controllers
{
    public class DetalleCajasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdExpositor,Titulo,Resumen,RedWhats,RedFacebook,RedInstagram,VideoYoutube,IdCaja,Modificado,RazonSocial,Rfc,Direccion,PaginaWeb")] DetalleCaja detalleCaja)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdExpositor,Titulo,Resumen,RedWhats,RedFacebook,RedInstagram,VideoYoutube,IdCaja,Modificado,RazonSocial,Rfc,Direccion,PaginaWeb")] DetalleCaja detalleCaja)
        {
