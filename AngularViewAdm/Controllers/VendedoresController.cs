...
namespace AngularViewAdm.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(u535755128_AngularviewContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdFreelance,Nombre,Token,Correo,Passworsd,Activo,Modificado,FechaCaducidad,Comision")] Vendedores vendedores)
        {
